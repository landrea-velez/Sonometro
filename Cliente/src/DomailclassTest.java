...
public class DomailclassTest {
  ...
  public static void main(String[] args) {
    ...
    // Get XML
    String xmlResponse = target.path("rest").path("domainclass").request()
        .accept(MediaType.TEXT_XML).get(String.class);
    // Get XML for application
    String xmlAppResponse =target.path("rest").path("domainclass").request()
  ...
  private static URI getBaseURI() {
    return UriBuilder.fromUri("http://localhost:8080/SonometroWS").build();
  }
